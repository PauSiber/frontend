...
for(var i = 0; i < 5; i++){ // Set a variable before the loop starts (var i = 0).
...
for(var i = 0; i < arr.length; i +=3){ // Define condition as i must be less than length of array. 
...
while( k < 3){ // The code block will be executed as long as a specified condition (k < 3) is true.
